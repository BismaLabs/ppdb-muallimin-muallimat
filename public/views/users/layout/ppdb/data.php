                ...
                <?php echo $this->session->flashdata('notif') ?>
                         ...
                         <div class="box-header with-border">
                            ...
                            <div class="box-body">
                                ...
                                <input type="text" class="form-control" id="nama_lengkap"
                                       value="<?php echo $this->session->userdata('nama_lengkap') ?>" name="nama"
                                ...
                                <input type="text" class="form-control" id="NIK" name="nik"
                                       value="<?php echo $userdata->nik ?>" placeholder="Masukkan NIK"
                                ...
                                <input type="text" class="form-control" id="tempat" name="tempat_lahir"
                                       value="<?php echo $userdata->tempat_lahir ?>"
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="anak_ke" placeholder="Jumlah"
                                                   name="anak_ke" value="<?php echo $userdata->anak_ke ?>"
                                                   style="border-radius: 0px">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="anak_ke" placeholder="Jumlah"
                                                   name="jumlah_anak_ke" value="<?php echo $userdata->jumlah_anak_ke ?>"
                                                   style="border-radius: 0px">
                                ...
                                <input type="text" class="form-control" id="saudara_kandung" name="jumlah_saudara_kandung"
                                       value="<?php echo $userdata->jumlah_saudara_kandung ?>"
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="jumlah_adik"
                                                   value="<?php echo $userdata->jumlah_adik ?>" placeholder="Jumlah"
                                                   class="form-control"
                                                   style="border-radius: 0px">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" name="jumlah_kakak"
                                               value="<?php echo $userdata->jumlah_kakak ?>" placeholder="Jumlah"
                                               class="form-control"
                                               style="border-radius: 0px">
                                ...
                                <input type="text" placeholder="Asrama" class="form-control" name="asrama"
                                       value="<?php echo $userdata->asrama ?>"
                                       style="border-radius: 0px">
                                    </div>
                                    <div class="form-group">
                                ...
                                <input type="text" placeholder="Nomor Kartu Keluarga" class="form-control" name="kk"
                                       value="<?php echo $userdata->kk ?>"
                                       style="border-radius: 0px">
                                <?php echo form_error('kk'); ?>
                                    </div>
                                    <div class="form-group">
                                <label>Nomor KIP/KPH <i>(*Jika Ada)</i></label>
                                <input type="text" placeholder="Nomor KIP/KPH" class="form-control" name="kip_pkh" value="<?php echo $userdata->kip_pkh ?>" 
                                       style="border-radius: 0px">
                                    </div>
                                    <div class="form-group">
                                <label>No. Telp./HP yang bisa dihubungi</label>
                                <input type="text" placeholder="No Hp/Telp" class="form-control" name="no_hp" value="<?php echo $userdata->no_telp ?>" style="border-radius: 0px">
                                    </div>
                                    <div class="form-group">
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Nama Madrasah" name="madrasah_asal"
                                                   value="<?php echo $userdata->nama_madrasah ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Kota/Kabupaten" name="kota_madrasah"
                                               value="<?php echo $userdata->kota_madrasah ?>" class="form-control"
                                               style="border-radius: 0px">
                                ...
                                <?php echo form_error('npsn'); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="No Seri Ijazah" name="no_ijazah"
                                                   ...
                                                   <?php echo $userdata->no_seri_ijazah ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" placeholder="No Seri SKHUN/SHUN" name="no_skhun"
                                               class="form-control" style="border-radius: 0px" value="
                                               <?php echo $userdata->no_seri_skhun ?>">
                                    </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <input type="text" placeholder="No UN" name="no_un"
                                           value="<?php echo $userdata->no_un ?> ?>" class="form-control"
                                           style="border-radius: 0px">
                    ...
                    <div class="box box-solid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="<?php echo $userdata->bidang_studi ?>" class="form-control" name="bidang_studi_digemari"
                                   placeholder="Masukkan Bidang Studi Anda" style="border-radius: 0px">
                        </div>
                        <div class="form-group">
                            <label> Bakat yang Dimiliki</label>
                            <input type="text" class="form-control" value="<?php echo $userdata->bakat_dimiliki ?>" name="bakat_dimiliki"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="olahraga_digemari"
                                   placeholder="Masukkan Olahraga yang Digemari" value="<?php echo $userdata->olahraga_digemari ?>" style="border-radius: 0px">
                        </div>
                        <div class="form-group">
                            <label> Cita-cita</label>
                            <input type="text" class="form-control" name="cita_cita"
                                   placeholder="Masukkan Cita-cita Anda" value="<?php echo $userdata->cita_cita ?>" style="border-radius: 0px">
                        </div>
                        </div>
                        </div>
                        </div>
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" name="nama_ayah" value="<?php echo $userdata->nama_ayah ?>"
                                                   placeholder="Masukkan Nama Lengkap Ayah" style="border-radius: 0px">
                                            <?php echo form_error('nama_ayah'); ?>
                                            <br/>
                                            <input type="text" class="form-control" name="nama_ibu" value="<?php echo $userdata->nama_ibu ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" name="no_ktp_ayah" value="<?php echo $userdata->no_ktp_ayah ?>"
                                                   placeholder="Masukkan Nomor KTP/NIK" style="border-radius: 0px">
                                            <?php echo form_error('no_ktp_ayah'); ?>
                                            <br/>
                                            <input type="text" class="form-control" name="no_ktp_ibu" value="<?php echo $userdata->no_ktp_ibu ?>"
                                                   placeholder="Masukkan Nomor KTP/NIK" style="border-radius: 0px">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <input type="text" class="form-control" name="pekerjaan_ayah" value="<?php echo $userdata->pekerjaan_ayah ?>"
                                                   placeholder="Masukkan Pekerjaan Ayah" style="border-radius: 0px">
                                            <?php echo form_error('pekerjaan_ayah'); ?>
                                            <br>
                                            <input type="text" class="form-control" name="pekerjaan_ibu" value="<?php echo $userdata->pekerjaan_ibu ?>"
                                                   placeholder="Masukkan Pekerjaan Ibu" style="border-radius: 0px">
                                            <?php echo form_error('pekerjaan_ibu'); ?>
                                        </div>

                                        <div class="col-md-3">
                                            <input type="text" class="form-control" name="pendidikan_ayah" value="<?php echo $userdata->pendidikan_ayah ?>"
                                                   placeholder="Masukkan Pendidikan Ayah" style="border-radius: 0px">
                                            <?php echo form_error('pendidikan_ayah'); ?>
                                            <br>
                                            <input type="text" class="form-control" name="pendidikan_ibu" value="<?php echo $userdata->pendidikan_ibu ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Jln Dsn.</label>
                                                <input type="text" class="form-control" name="jln_dsn" value="<?php echo $userdata->jln_desa ?>"
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>RT</label>
                                                <input type="text" class="form-control" name="rt" style="border-radius: 0px" value="<?php echo $userdata->rt ?>"
                                                       placeholder="RT">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>RW</label>
                                                <input type="text" class="form-control" name="rw" style="border-radius: 0px" value="<?php echo $userdata->rw ?>"
                                                       placeholder="RW">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Desa.</label>
                                                <input type="text" class="form-control" name="desa" placeholder="Desa" value="<?php echo $userdata->desa ?>"
                                                       style="border-radius: 0px">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Kec.</label>
                                                <input type="text" class="form-control" name="kecamatan" placeholder="Kecamatan" value="<?php echo $userdata->kecamatan ?>"
                                                       style="border-radius: 0px">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Kab.</label>
                                                <input type="text" class="form-control" name="kabupaten" value="<?php echo $userdata->kabupaten ?>"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="kode_pos" value="<?php echo $userdata->kode_pos ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="text" class="form-control" name="no_hp_ayah" value="<?php echo $userdata->no_tlp_ayah ?>"
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-3">
                                                <label>Nomor HP Orang Tua</label>
                                                <input type="text" class="form-control" name="no_hp_ibu" value="<?php echo $userdata->no_tlp_ibu ?>"
                                                       placeholder="Nomor Telp/HP Orang Tua" style="border-radius: 0px">
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="box box-solid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="<?php echo $userdata->nama_wali ?>" name="nama_wali">
                            </div>
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Nomor KK Wali" value="<?php echo $userdata->no_kk_wali ?>" name="no_kk_wali"
                                                   class="form-control" style="border-radius: 0px">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <label>Nomor KTP Wali</label>
                                        <input type="text" placeholder="Nomor KTP Wali" value="<?php echo $userdata->no_ktp_wali ?>" name="no_ktp_wali"
                                               class="form-control" style="border-radius: 0px">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Pekerjaan" name="pekerjaan_wali"
                                                  value="<?php echo $userdata->pekerjaan_wali ?>" class="form-control" style="border-radius: 0px">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <label>Pendidikan</label>
                                        <input type="text" placeholder="Pendidikan" name="pendidikan_wali"
                                               class="form-control" value="<?php echo $userdata->pendidikan_wali ?>" style="border-radius: 0px">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="jl_dsn_wali"
                                                  value="<?php echo $userdata->jln_desa_wali ?>" placeholder="Masukkan Jalan Dusun " style="border-radius: 0px">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>RT</label>
                                            <input type="text" class="form-control" value="<?php echo $userdata->rt_wali ?>" name="rt_wali"
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>RW</label>
                                            <input type="text" value="<?php echo $userdata->rw_wali ?>" class="form-control" name="rw_wali"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Desa.</label>
                                            <input type="text" class="form-control" value="<?php echo $userdata->desa_wali ?>" name="desa_wali" placeholder="Desa"
                                                   style="border-radius: 0px">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Kec.</label>
                                            <input type="text" value="<?php echo $userdata->kecamatan_wali ?>" class="form-control" name="kecamatan_wali"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Kab.</label>
                                            <input type="text" value="<?php echo $userdata->kabupaten_wali ?>" class="form-control" name="kabupaten_wali"
                                                   placeholder="Masukkan Kabupaten/Kota " style="border-radius: 0px">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Kode POS</label>
                                            <input type="text" class="form-control" value="<?php echo $userdata->kode_pos_wali ?>" name="kode_pos_wali"
                                                   placeholder="Masukkan Kode POS " style="border-radius: 0px">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
