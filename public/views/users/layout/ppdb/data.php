                    ...
                    <div class="box box-solid">
                         ...
                         <div class="box-body">
                           <div class="card">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <br/>
                                    <label class="alert alert-success"  style="border-radius: 0px">
                           ...
                           <div class="form-group">
                                ...
                                <input type="text" disabled=""  class="form-control" id="nama_lengkap"
                           ...
                           <div class="form-group">
                                ...
                                <select id="jenis_kelamin" disabled="" class="form-control" name="jenis_kelamin">
                           ...
                           <div class="form-group">
                                ...
                                <input type="text" disabled=""  class="form-control" id="nisn" name="nisn"
                          ...
                          <div class="form-group">
                                ...
                                <input type="text" disabled=""  class="form-control" id="NIK" name="nik"
                          ...
                          <div class="form-group">
                                ...
                                <input type="text" disabled=""  class="form-control" id="tempat" name="tempat_lahir"
                         ...
                         <div class="form-group">
                                    <div class="row">
                                     <div class="col-md-3">
                                        ...
                                        <select class="form-control" disabled="" name="tanggal_lahir" id="tanggal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select style="" disabled="" class="form-control" name="bulan_lahir">
                                    ...
                                    <div class="form-group">
                                        <label for="tahun">Tahun <span class="required"
                                                                       style="color: red">*</span></label>
                                        <select class="form-control" disabled="" name="tahun_lahir" id="tahun">
                          ...
                          <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <input type="text" disabled class="form-control" id="anak_ke" placeholder="Jumlah"
                                ...
                                <input type="text" class="form-control" id="saudara_kandung" name="jumlah_saudara_kandung"
                                       ...
                                       placeholder="Saudara Kandung" style="border-radius: 0px" disabled>
                                ...
                                <input type="text" placeholder="No Hp/Telp" class="form-control" name="no_hp" value="<?php echo $hasil->no_telp ?>" style="border-radius: 0px" disabled>
                                    </div>
                                    <div class="form-group">
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Nama Madrasah" name="madrasah_asal"
                                                   ...
                                                   class="form-control" style="border-radius: 0px" disabled>
                    ...
                    <div class="box box-solid">
                        ...
                        <div class="box-body">
                           <div class="card">
                            ...
                            <input type="text" value="<?php echo $hasil->bidang_studi ?>" class="form-control" name="bidang_studi_digemari"
                                   placeholder="Masukkan Bidang Studi Anda" style="border-radius: 0px" disabled>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="olahraga_digemari"
                                   placeholder="Masukkan Olahraga yang Digemari" value="<?php echo $hasil->olahraga_digemari ?>" style="border-radius: 0px" disabled>
                        </div>
                        <div class="form-group">
                            <label> Cita-cita</label>
                            <input type="text" class="form-control" name="cita_cita"
                                   placeholder="Masukkan Cita-cita Anda" value="<?php echo $hasil->cita_cita ?>" style="border-radius: 0px" disabled>
                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" name="nama_ayah" value="<?php echo $hasil->nama_ayah ?>"
                                                   placeholder="Masukkan Nama Lengkap Ayah" style="border-radius: 0px" disabled>
                                            <?php echo form_error('nama_ayah'); ?>
                                            <br/>
                                            <input type="text" class="form-control" name="nama_ibu" value="<?php echo $hasil->nama_ibu ?>"
                                                   placeholder="Masukkan Nama Ibu" style="border-radius: 0px" disabled>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" name="no_ktp_ayah" value="<?php echo $hasil->no_ktp_ayah ?>"
                                                   placeholder="Masukkan Nomor KTP/NIK" style="border-radius: 0px" disabled>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <input type="text" class="form-control" name="pekerjaan_ayah" value="<?php echo $hasil->pekerjaan_ayah ?>"
                                                   placeholder="Masukkan Pekerjaan Ayah" style="border-radius: 0px" disabled>
                                            ...
                                            <input type="text" class="form-control" name="pekerjaan_ibu" value="<?php echo $hasil->pekerjaan_ibu ?>"
                                                   placeholder="Masukkan Pekerjaan Ibu" style="border-radius: 0px" disabled>
                                        ...
                                        <div class="col-md-3">
                                            <input type="text" class="form-control" name="pendidikan_ayah" value="<?php echo $hasil->pendidikan_ayah ?>"
                                                   placeholder="Masukkan Pendidikan Ayah" style="border-radius: 0px" disabled>
                                            ...
                                            <input type="text" class="form-control" name="pendidikan_ibu" value="<?php echo $hasil->pendidikan_ibu ?>"
                                                   placeholder="Masukkan Pendidikan Ibu" style="border-radius: 0px" disabled>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="jln_dsn" value="<?php echo $hasil->jln_desa ?>"
                                                       placeholder="Masukkan Jalan Dusun " style="border-radius: 0px" disabled>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="kabupaten" value="<?php echo $hasil->kabupaten ?>"
                                                       placeholder="Masukkan Kabupaten/Kota " style="border-radius: 0px" disabled>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="kode_pos" value="<?php echo $hasil->kode_pos ?>"
                                                       placeholder="Masukkan Kode POS " style="border-radius: 0px" disabled>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="text" disabled class="form-control" name="no_hp_ayah" value="<?php echo $hasil->no_tlp_ayah ?>"
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-3">
                                                <label>Nomor HP Orang Tua</label>
                                                <input type="text" disabled class="form-control" name="no_hp_ibu" value="<?php echo $hasil->no_tlp_ibu ?>"
                                                       placeholder="Nomor Telp/HP Orang Tua" style="border-radius: 0px">
                                            </div>
                                        </div>
                                    </div>
                           ...
                           <div class="card">
                              <div class="card-content">
                               ...
                               <div class="form-group">
                                ...
                                <input type="text" class="form-control" disabled value="<?php echo $hasil->nama_wali ?>" name="nama_wali">
                                </div>
                            <div class="form-group">
                                <label for="jenis_kelamin_wali"> JENIS KELAMIN</label>
                                <select id="jenis_kelamin_wali" disabled="" class="form-control" name="jenis_kelamin_wali">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Nomor KK Wali" value="<?php echo $hasil->no_kk_wali ?>" disabled name="no_kk_wali"
                                                   class="form-control" style="border-radius: 0px"><?php echo $this->session->userdata('no_kk_wali') ?>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <label>Nomor KTP Wali</label>
                                        <input type="text" placeholder="Nomor KTP Wali" value="<?php echo $hasil->no_ktp_wali ?>" disabled name="no_ktp_wali"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Pekerjaan" name="<?php echo $hasil->pekerjaan_wali ?>" disabled class="form-control" style="border-radius: 0px">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <label>Pendidikan</label>
                                        <input type="text" placeholder="Pendidikan" name="pendidikan_wali"
                                               class="form-control" disabled value="<?php echo $hasil->pendidikan_wali ?>" style="border-radius: 0px">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="jl_dsn_wali"
                                                  value="<?php echo $hasil->jln_desa_wali ?>" placeholder="Masukkan Jalan Dusun " disabled style="border-radius: 0px">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Desa.</label>
                                            <input type="text" class="form-control" value="<?php echo $hasil->desa_wali ?>" name="desa_wali" disabled placeholder="Desa"
                                                   style="border-radius: 0px">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
