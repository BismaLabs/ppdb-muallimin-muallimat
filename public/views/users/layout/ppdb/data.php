                                            ...
                                            <div class="card-content">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" disabled="" class="form-control"
                                                           id="nama_lengkap"
                                                           value="<?php echo $hasil->nama_lengkap ?>" name="nama"
                                                ...
                                                <div class="form-group">
                                                    <label for="jenis_kelamin"> JENIS KELAMIN <span class="required"
                                                                                                    style="color: red">*</span></label>
                                                    <select id="jenis_kelamin" disabled="" class="form-control"
                                                            name="jenis_kelamin">
                                                        <option><?php echo $hasil->jenis_kelamin ?></option>
                                                    </select>
                                                    <?php echo form_error('jenis_kelamin'); ?>
                                                </div>
                                                <div class="form-group">
                                                    <label for="NISN"> NISN <i>(Nomor Induk Siswa Nasional) <span
                                                                    class="required"
                                                ...
                                                <div class="form-group">
                                                    <label for="NIK"> NIK <i>(Nomor Induk Kependudukan) <span
                                                                    class="required"
                                                                    style="color: red">*</span></i></label>
                                                    <input type="text" disabled="" class="form-control" id="NIK"
                                                           name="nik"
                                                ...
                                                <div class="form-group">
                                                    <label for="tempat"> Tempat Lahir <span class="required"
                                                                                            style="color: red">*</span></label>
                                                    <input type="text" disabled="" class="form-control" id="tempat"
                                                           name="tempat_lahir"
                                                ...
                                                <div class="form-group">
                                                    <label for="anak_ke"> Anak Ke <span class="required"
                                                                                        style="color: red">*</span></label>
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <input type="text" disabled class="form-control"
                                                                       id="anak_ke" placeholder="Jumlah"
                                                                       name="anak_ke"
                                                                       value="<?php echo $hasil->anak_ke ?>"
                                                                       style="border-radius: 0px" disabled>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <input type="text" class="form-control" id="anak_ke"
                                                                       placeholder="Jumlah"
                                                                       name="jumlah_anak_ke"
                                                                       value="<?php echo $hasil->jumlah_anak_ke ?>"
                                                                       style="border-radius: 0px" disabled>
                                                ...
                                                <div class="form-group">
                                                    <label for="saudara_kandung"> Jumlah Saudara Kandung <span
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="jumlah_adik"
                                                                       value="<?php echo $hasil->jumlah_adik ?>"
                                                                       placeholder="Jumlah"
                                                                       class="form-control"
                                                                       style="border-radius: 0px" disabled>
                                                        ...
                                                        <div class="col-md-3">
                                                            <label>Jumlah Kakak <span class="required"
                                                                                      style="color: red">*</span></label>
                                                            <input type="text" name="jumlah_kakak"
                                                                   value="<?php echo $hasil->jumlah_kakak ?>"
                                                                   placeholder="Jumlah"
                                                                   class="form-control"
                                                                   style="border-radius: 0px" disabled>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="Asrama" class="form-control"
                                                           name="asrama"
                                                ...
                                                <div class="form-group">
                                                    <label>Nomor Kartu Keluarga <i>(KK) <span class="required"
                                                                                              style="color: red">*</span></i></label>
                                                    <input type="text" placeholder="Nomor Kartu Keluarga"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="Nomor KIP/KPH" class="form-control"
                                                           name="kip_pkh" value="<?php echo $hasil->kip_pkh ?>"
                                                           style="border-radius: 0px" disabled>
                                                </div>
                                                <div class="form-group">
                                                    <label>No. Telp./HP yang bisa dihubungi</label>
                                                    <input type="text" placeholder="No Hp/Telp" class="form-control"
                                                           name="no_hp" value="<?php echo $hasil->no_telp ?>"
                                                           style="border-radius: 0px" disabled>
                                                </div>
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-8">
                                                            <div class="form-group">
                                                                <label>Nama Madrasah Asal <i>(*Disertai Kota Madrasah)
                                                                        <span
                                                                                class="required"
                                                                                style="color: red">*</span></i></label>
                                                                <input type="text" placeholder="Nama Madrasah"
                                                                       name="madrasah_asal"
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label>Kota <span class="required"
                                                                                  style="color: red">*</span></label>
                                                                <input type="text" placeholder="Kota/Kabupaten"
                                                                       name="kota_madrasah"
                                                                       value="<?php echo $hasil->kota_madrasah ?>"
                                                                       class="form-control"
                                                                       style="border-radius: 0px" disabled>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="No NPSN" class="form-control"
                                                           name="npsn"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" placeholder="No Seri Ijazah"
                                                                       name="no_ijazah"
                                                                       class="form-control" style="border-radius: 0px"
                                                                       value="
                                                   <?php echo $hasil->no_seri_ijazah ?>" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label>Nomor Seri SKHUN atau SHUN</label>
                                                            <input type="text" placeholder="No Seri SKHUN/SHUN"
                                                                   name="no_skhun"
                                                                   class="form-control" style="border-radius: 0px"
                                                                   value="
                                               <?php echo $hasil->no_seri_skhun ?>" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                            ...
                            <div class="card">
                                <div class="card-content">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?php echo $hasil->bidang_studi ?>"
                                               class="form-control" name="bidang_studi_digemari"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                               value="<?php echo $hasil->bakat_dimiliki ?>" name="bakat_dimiliki"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="olahraga_digemari"
                                               ...
                                               value="<?php echo $hasil->olahraga_digemari ?>"
                                               style="border-radius: 0px" disabled>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="cita_cita"
                                               ...
                                               value="<?php echo $hasil->cita_cita ?>" style="border-radius: 0px"
                                               disabled>
                                    </div>
                        ...
                        <div class="box-body">
                            <div class="card">
                                <div class="card-content">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" name="nama_ayah"
                                                       value="<?php echo $hasil->nama_ayah ?>"
                                                       placeholder="Masukkan Nama Lengkap Ayah"
                                                       style="border-radius: 0px" disabled>
                                                <?php echo form_error('nama_ayah'); ?>
                                                <br/>
                                                <input type="text" class="form-control" name="nama_ibu"
                                                       value="<?php echo $hasil->nama_ibu ?>"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" name="no_ktp_ayah"
                                                       value="<?php echo $hasil->no_ktp_ayah ?>"
                                                ...
                                                <input type="text" class="form-control" name="no_ktp_ibu"
                                                       value="<?php echo $hasil->no_ktp_ibu ?>"
                                                       placeholder="Masukkan Nomor KTP/NIK" style="border-radius: 0px"
                                                       disabled>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" class="form-control" name="pendidikan_ayah"
                                                       value="<?php echo $hasil->pendidikan_ayah ?>"
                                                ...
                                                <input type="text" class="form-control" name="pendidikan_ibu"
                                                       value="<?php echo $hasil->pendidikan_ibu ?>"
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="jln_dsn"
                                                           value="<?php echo $hasil->jln_desa ?>"
                                                           placeholder="Masukkan Jalan Dusun "
                                                           style="border-radius: 0px" disabled>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="rt"
                                                           style="border-radius: 0px" value="<?php echo $hasil->rt ?>"
                                                           placeholder="RT" disabled>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="rw"
                                                           style="border-radius: 0px" value="<?php echo $hasil->rw ?>"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="desa"
                                                           placeholder="Desa" value="<?php echo $hasil->desa ?>"
                                                           style="border-radius: 0px" disabled>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="kecamatan"
                                                           ...
                                                           value="<?php echo $hasil->kecamatan ?>"
                                                           style="border-radius: 0px" disabled>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="kabupaten"
                                                           value="<?php echo $hasil->kabupaten ?>"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select disabled="" class="form-control" name="provinsi">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <br>
                                                <select class="form-control" disabled="" name="penghasilan_ibu">
                                    ...
                                    <div class="form-group">
                                        <label> Keterangan Dan Nomor HP <span class="required"
                                                                              style="color: red">*</span></label>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <label>a. Ayah </label>
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-3">
                                                    ...
                                                    <select class="form-control" disabled name="keterangan_ayah">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-3">
                                                        ...
                                                        <input type="text" disabled class="form-control"
                                                               name="no_hp_ayah"
                                                               value="<?php echo $hasil->no_tlp_ayah ?>"
                                                               placeholder="Nomor Telp/HP Orang Tua"
                                                               style="border-radius: 0px">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-md-3">
                                                    <label>Keterangan</label>
                                                    <select class="form-control" disabled="" name="keterangan_ibu">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-3">
                                                    <label>Nomor HP Orang Tua</label>
                                                    <input type="text" disabled class="form-control" name="no_hp_ibu"
                                                           value="<?php echo $hasil->no_tlp_ibu ?>"
                                                           placeholder="Nomor Telp/HP Orang Tua"
                                                           style="border-radius: 0px">
                                                </div>
                                            </div>
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" disabled
                                               value="<?php echo $hasil->nama_wali ?>" name="nama_wali">
                                    </div>
                                    <div class="form-group">
                                        <label for="jenis_kelamin_wali"> JENIS KELAMIN</label>
                                        <select id="jenis_kelamin_wali" disabled="" class="form-control"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="Nomor KK Wali"
                                                           value="<?php echo $hasil->no_kk_wali ?>" disabled
                                                           name="no_kk_wali"
                                                           class="form-control"
                                                           style="border-radius: 0px"><?php echo $this->session->userdata('no_kk_wali') ?>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <label>Nomor KTP Wali</label>
                                                <input type="text" placeholder="Nomor KTP Wali"
                                                       value="<?php echo $hasil->no_ktp_wali ?>" disabled
                                                       name="no_ktp_wali"
                                                       class="form-control" style="border-radius: 0px">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="Pekerjaan"
                                                           name="<?php echo $hasil->pekerjaan_wali ?>" disabled
                                                           class="form-control" style="border-radius: 0px">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" placeholder="Pendidikan" name="pendidikan_wali"
                                                       ...
                                                       value="<?php echo $hasil->pendidikan_wali ?>"
                                                       style="border-radius: 0px">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="jl_dsn_wali"
                                                           value="<?php echo $hasil->jln_desa_wali ?>"
                                                           placeholder="Masukkan Jalan Dusun " disabled
                                                           style="border-radius: 0px">
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label>RT</label>
                                                    <input type="text" class="form-control"
                                                           value="<?php echo $hasil->rt_wali ?>" name="rt_wali"
                                                           style="border-radius: 0px" disabled placeholder="RT">
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label>RW</label>
                                                    <input type="text" value="<?php echo $hasil->rw_wali ?>"
                                                           class="form-control" name="rw_wali"
                                                           style="border-radius: 0px" disabled placeholder="RW">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>Desa.</label>
                                                    <input type="text" class="form-control"
                                                           value="<?php echo $hasil->desa_wali ?>" name="desa_wali"
                                                           disabled placeholder="Desa"
                                                           style="border-radius: 0px">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>Kec.</label>
                                                    <input type="text" value="<?php echo $hasil->kecamatan_wali ?>"
                                                           class="form-control" name="kecamatan_wali"
                                                           placeholder="Kecamatan"
                                                           style="border-radius: 0px" disabled>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>Kab.</label>
                                                    <input type="text" value="<?php echo $hasil->kabupaten_wali ?>"
                                                           class="form-control" name="kabupaten_wali"
                                                           placeholder="Masukkan Kabupaten/Kota "
                                                           style="border-radius: 0px" disabled>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>Kode POS</label>
                                                    <input type="text" class="form-control"
                                                           value="<?php echo $hasil->kode_pos_wali ?>"
                                                           name="kode_pos_wali"
                                                           placeholder="Masukkan Kode POS " style="border-radius: 0px"
                                                           disabled>
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>Provinsi</label>
                                                    <select class="form-control" disabled="" name="provinsi_wali">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <select class="form-control" disabled name="penghasilan_wali">
