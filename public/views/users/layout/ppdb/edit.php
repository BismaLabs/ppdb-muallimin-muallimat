                         ...
                         <div class="box-header with-border">
                          ...
                          <div class="form-group">
                                ...
                                <input type="text"  class="form-control" id="NIK" name="nik"
                                       value="<?php echo $edit_user['nik'] ?>" placeholder="Masukkan NIK"
                          ...
                          <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="tempat" name="tempat_lahir"
                                       value="<?php echo $edit_user['tempat_lahir'] ?>"
                         ...
                         <div class="form-group">
                          ...
                          <div class="form-group">
                                ...
                                <div class="col-md-3">
                                  <label style="margin-top: 7px;"> Dari</label>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="anak_ke" placeholder="Jumlah"
                                                   name="jumlah_anak_ke" value="<?php echo  $edit_user['jumlah_anak_ke'] ?>"
                                                   style="border-radius: 0px" >
                                ...
                                <input type="text" class="form-control" id="saudara_kandung" name="jumlah_saudara_kandung"
                                       value="<?php echo  $edit_user['jumlah_saudara_kandung'] ?>"
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="jumlah_adik"
                                                   value="<?php echo  $edit_user['jumlah_adik'] ?>" placeholder="Jumlah"
                                                   class="form-control"
                                                   style="border-radius: 0px" >
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" name="jumlah_kakak"
                                               value="<?php echo  $edit_user['jumlah_kakak'] ?>" placeholder="Jumlah"
                                               class="form-control"
                                               style="border-radius: 0px" >
                                ...
                                <input type="text" placeholder="Nomor Kartu Keluarga" class="form-control" name="kk"
                                       value="<?php echo  $edit_user['kk']?>"
                                       style="border-radius: 0px" >
                                <?php echo form_error('kk'); ?>
                                    </div>
                                    <div class="form-group">
                                <label>Nomor KIP/KPH <i>(*Jika Ada)</i></label>
                                <input type="text" placeholder="Nomor KIP/KPH" class="form-control" name="kip_pkh" value="<?php echo  $edit_user['kip_pkh'] ?>" 
                                       style="border-radius: 0px" >
                                    </div>
                                    <div class="form-group">
                                <label>No. Telp./HP yang bisa dihubungi</label>
                                <input type="text" placeholder="No Hp/Telp" class="form-control" name="no_hp" value="<?php echo  $edit_user['no_telp'] ?>" style="border-radius: 0px" >
                                    </div>
                                    <div class="form-group">
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Nama Madrasah" name="madrasah_asal"
                                                   value="<?php echo  $edit_user['nama_madrasah'] ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Kota/Kabupaten" name="kota_madrasah"
                                               value="<?php echo  $edit_user['kota_madrasah'] ?>" class="form-control"style="border-radius: 0px" >
                                ...
                                <?php echo form_error('npsn'); ?>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" placeholder="No Seri SKHUN/SHUN" name="no_skhun"
                                               class="form-control" style="border-radius: 0px" value="
                                               <?php echo  $edit_user['no_seri_skhun']?>" >
                                    </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <input type="text" placeholder="No UN" name="no_un"
                                           value="<?php echo  $edit_user['no_un'] ?>" class="form-control"
                                           style="border-radius: 0px" >
                    ...
                    <div class="box box-solid">
                        ...
                        <div class="box-body">
                           <div class="card">
                            ...
                            <input type="text" value="<?php echo  $edit_user['bidang_studi'] ?>" class="form-control" name="bidang_studi_digemari"
                                   placeholder="Masukkan Bidang Studi Anda" style="border-radius: 0px" >
                        </div>
                        <div class="form-group">
                            <label> Bakat yang Dimiliki</label>
                            <input type="text" class="form-control" value="<?php echo  $edit_user['bakat_dimiliki'] ?>" name="bakat_dimiliki"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="olahraga_digemari"
                                   placeholder="Masukkan Olahraga yang Digemari" value="<?php echo  $edit_user['olahraga_digemari'] ?>" style="border-radius: 0px" >
                        </div>
                        <div class="form-group">
                            <label> Cita-cita</label>
                            <input type="text" class="form-control" name="cita_cita"
                                   placeholder="Masukkan Cita-cita Anda" value="<?php echo  $edit_user['cita_cita'] ?>" style="border-radius: 0px" >
                        </div>
                           ...
                           <div class="card">
                              <div class="card-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" name="nama_ayah" value="<?php echo  $edit_user['nama_ayah'] ?>"
                                                   placeholder="Masukkan Nama Lengkap Ayah" style="border-radius: 0px" >
                                            <?php echo form_error('nama_ayah'); ?>
                                            <br/>
                                            <input type="text" class="form-control" name="nama_ibu" value="<?php echo  $edit_user['nama_ibu'] ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" name="no_ktp_ayah" value="<?php echo  $edit_user['no_ktp_ayah'] ?>"
                                                   placeholder="Masukkan Nomor KTP/NIK" style="border-radius: 0px" >
                                            <?php echo form_error('no_ktp_ayah'); ?>
                                            <br/>
                                            <input type="text" class="form-control" name="no_ktp_ibu" value="<?php echo  $edit_user['no_ktp_ibu'] ?>"
                                                   placeholder="Masukkan Nomor KTP/NIK" style="border-radius: 0px" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <input type="text" class="form-control" name="pekerjaan_ayah" value="<?php echo  $edit_user['pekerjaan_ayah'] ?>"
                                                   placeholder="Masukkan Pekerjaan Ayah" style="border-radius: 0px" >
                                            <?php echo form_error('pekerjaan_ayah'); ?>
                                            <br>
                                            <input type="text" class="form-control" name="pekerjaan_ibu" value="<?php echo  $edit_user['pekerjaan_ibu'] ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Jln Dsn.</label>
                                                <input type="text" class="form-control" name="jln_dsn" value="<?php echo  $edit_user['jln_desa'] ?>"
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>RT</label>
                                                <input type="text" class="form-control" name="rt" style="border-radius: 0px" value="<?php echo  $edit_user['rt'] ?>"
                                                       placeholder="RT" >
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>RW</label>
                                                <input type="text" class="form-control" name="rw" style="border-radius: 0px" value="<?php echo  $edit_user['rw'] ?>"
                                                       placeholder="RW" >
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Desa.</label>
                                                <input type="text" class="form-control" name="desa" placeholder="Desa" value="<?php echo  $edit_user['desa'] ?>"
                                                       style="border-radius: 0px" >
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Kec.</label>
                                                <input type="text" class="form-control" name="kecamatan" placeholder="Kecamatan" value="<?php echo  $edit_user['kecamatan'] ?>"
                                                       style="border-radius: 0px" >
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Kab.</label>
                                                <input type="text" class="form-control" name="kabupaten" value="<?php echo  $edit_user['kabupaten'] ?>"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="kode_pos" value="<?php echo  $edit_user['kode_pos'] ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="text"  class="form-control" name="no_hp_ayah" value="<?php echo  $edit_user['no_tlp_ayah'] ?>"
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-3">
                                                <label>Nomor HP Orang Tua</label>
                                                <input type="text" class="form-control" name="no_hp_ibu" value="<?php echo  $edit_user['no_tlp_ibu'] ?>"
                                                       placeholder="Nomor Telp/HP Orang Tua" style="border-radius: 0px">
                                            </div>
                                        </div>
                                    </div>
                           ...
                           <div class="card">
                              <div class="card-content">
                               ...
                               <div class="form-group">
                                ...
                                <input type="text" class="form-control"  value="<?php echo  $edit_user['nama_wali'] ?>" name="nama_wali">
                                </div>
                            <div class="form-group">
                                <label for="jenis_kelamin_wali"> JENIS KELAMIN</label>
                                <select id="jenis_kelamin_wali" class="form-control" name="jenis_kelamin_wali">
                                    <option><?php echo  $edit_user['jenis_kelamin_wali']?></option>
                                </select>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Nomor KK Wali" value="<?php echo  $edit_user['no_kk_wali'] ?>" name="no_kk_wali"
                                                   class="form-control" style="border-radius: 0px"><?php echo $this->session->userdata('no_kk_wali') ?>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <label>Nomor KTP Wali</label>
                                        <input type="text" placeholder="Nomor KTP Wali" value="<?php echo  $edit_user['no_ktp_wali'] ?>" name="no_ktp_wali"
                                               class="form-control" style="border-radius: 0px">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Pekerjaan" name="<?php echo  $edit_user['pekerjaan_wali'] ?>" class="form-control" style="border-radius: 0px">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <label>Pendidikan</label>
                                        <input type="text" placeholder="Pendidikan" name="pendidikan_wali"
                                               class="form-control" value="<?php echo  $edit_user['pekerjaan_wali'] ?>" style="border-radius: 0px">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="jl_dsn_wali"
                                                  value="<?php echo  $edit_user['jln_desa_wali'] ?>" placeholder="Masukkan Jalan Dusun " style="border-radius: 0px">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>RT</label>
                                            <input type="text" class="form-control" value="<?php echo  $edit_user['rt_wali'] ?>" name="rt_wali"
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>RW</label>
                                            <input type="text" value="<?php echo  $edit_user['rw_wali'] ?>" class="form-control" name="rw_wali"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Desa.</label>
                                            <input type="text" class="form-control" value="<?php echo  $edit_user['desa_wali'] ?>" name="desa_wali" placeholder="Desa"
                                                   style="border-radius: 0px">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Kec.</label>
                                            <input type="text" value="<?php echo  $edit_user['kecamatan_wali']?>" class="form-control" name="kecamatan_wali"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Kab.</label>
                                            <input type="text" value="<?php echo  $edit_user['kabupaten_wali']?>" class="form-control" name="kabupaten_wali"
                                                   placeholder="Masukkan Kabupaten/Kota " style="border-radius: 0px" >
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Kode POS</label>
                                            <input type="text" class="form-control" value="<?php echo  $edit_user['kode_pos_wali'] ?>" name="kode_pos_wali"
                                                   placeholder="Masukkan Kode POS " style="border-radius: 0px" >
                                        </div>
                                    </div>
                                    <div class="col-md-4">
