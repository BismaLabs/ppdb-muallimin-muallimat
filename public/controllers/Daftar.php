...
class Daftar extends CI_Controller {
    ...
    public function index()
    {
        ...
        //set
        $this->form_validation->set_rules('jln_desa', 'Alamat Jalan', 'required');
        //set
        ...
        if($this->form_validation->run() == TRUE)
        {
            ...
            if($checking_kode != FALSE)
            {
                ...
                $insert = array(
                        ...
                        'jumlah_saudara_kandung'    => $this->input->post("jumlah_saudara_landung"),
                        ...
                        'no_seri_skhun'             => $this->input->post("no_seri_skhun"),
                        ...
                        'jln_desa'                  => $this->input->post("jln_desa"),
                        ...
                        'penghasilan_rata_ayah'     => $this->input->post("penghasilan_rata_ayah"),
                        'penghasilan_rata_ibu'      => $this->input->post("penghasilan_rata_ibu"),
                        'keterangan_ayah'           => $this->input->post("keterangan_ayah"),
                        'keterangan_ibu'            => $this->input->post("keterangan_ibu"),
                        'no_telp_ayah'              => $this->input->post("no_hp_ayah"),
                        'no_telp_ibu'               => $this->input->post("no_hp_ibu"),
                        ...
                        'jln_desa_wali'             => $this->input->post("jln_desa_wali"),
                        ...
                        'penghasilan_rata_wali'     => $this->input->post("penghasilan_rata_wali"),
                        'status'                    => "0",
                );
